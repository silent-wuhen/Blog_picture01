...
# 参数2
old_image_prefix="https://cdn.jsdelivr.net/gh/silent-wuhen/Blog_picture01/H01_开发技能/1.Githttps://cdn.jsdelivr.net/gh/silent-wuhen/Blog_picture01/H01_开发技能/1.Githttps://github.com/silent-wuhen/Blog_picture01/blob/main/3.%E6%96%87%E6%A1%A3%E5%9B%BE%E7%89%87/2.GitGithub/1.Git基础/Git基础Github/1.Git基础/Git基础"  # 替换为要修改的图片网址前缀
# 参数3
